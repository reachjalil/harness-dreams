...
import { ReviewCompass } from "./ReviewCompass";
import {
  OVERVIEW_ID,
  QUEUE_ID,
  type Decisions,
  useReviewWizard,
} from "./useReviewWizard";
    ...
    <div className="col">
      ...
      {hasFindings ? (
        <ReviewCompass
          ...
          decisions={decisions}
          step={step}
          onOverview={() => setActiveId(OVERVIEW_ID)}
      ...
      <div className="review-step" key={step}>
        ...
        {step === "findings" ? (
          <ReviewFindings
            ...
            onDecide={decide}
            onBackToOverview={() => setActiveId(OVERVIEW_ID)}
        ...
        {onQueue ? (
          <>
            <ReviewQueue
              ...
              onUndo={undo}
              onBackToFindings={() =>
                setActiveId(report.findings[0]?.id ?? OVERVIEW_ID)
              }
            />
            <Section
