...
import type { HealthReport, LiveTelemetrySnapshot } from "../../shared/types";
...
import { LoopOutcome } from "./LoopOutcome";
import { useLoopImpact } from "./useLoopImpact";
...
export default function Today({
  ...
  const impact = useLoopImpact(reports, report);
